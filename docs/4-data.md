...
ECMWF Open Data (0.25° GRIB2)
   ...
   영역 절단: lon 108~148E, lat 18~48N  (홍콩·중국 동부·대만·한반도·일본)
...
```
영역: lonMin 108.0, lonMax 148.0, latMin 18.0, latMax 48.0
해상도: 0.25° (약 25km) → 폭 161 × 높이 121 격자
...
**저장 용량 추정**: 동아시아 영역은 스텝당 19,481개 격자점이다. JSON PoC는 전체 run(+0~120h, 41스텝 × 4변수)이 약 100MB이며, 운영에서는 Float16 바이너리와 타일 압축으로 전송량을 줄인다.
